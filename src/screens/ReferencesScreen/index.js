...
export default class ExperimenScreen extends React.Component {
  ...
  render() {
    let viewShow1, viewShow2, viewShow3, showClose, 
        showMenu, showRef, custumerText, locationText, smuDate;
    ...
    if (this.state.custumer != null){
      custumerText = <Text style={styles.textBold}>{this.state.custumer}</Text>
    }else{
      custumerText = <Text style={styles.textBold}>-</Text>
    }

    if (this.state.SMUUpdate !=null){
      smuDate = <Text style={styles.textBold}>{this.state.SMUUpdate.substring(0, 10)}</Text>
    }else{
      smuDate = <Text style={styles.textBold}>-</Text>
    }
