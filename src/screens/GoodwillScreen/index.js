...
export default class ExperimenScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isModalFormKosongPartsDesc: false,
...
actionTR() {
  ...
  registerCall() {
    ...
    formData.append('PartsDescription', ""+this.state.dataPartDesc);
  ...
  validationForm() {
    ...
    } else if (this.state.dataPartDesc === '') {
      return this.setState({ isModalFormKosongPartsDesc: true, isLoadingSubmit: false });
  ...
  validationFormSaveDraft() {
    ...
    // } else if (this.state.dataPartsCausing === '' || this.state.dataPartsCausing === null) {
    //   this.setState({ isModalFormKosongPartCausing: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataPartDesc === '' || this.state.dataPartDesc === null) {
    //   this.setState({ isModalFormKosongPartsDesc: true, isLoadingSaveDraft: false });
  ...
  toogleDonePartDesc() {
    this.setState({ isModalFormKosongPartsDesc: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneResponder() {
  ...
  render() {
        ...
        <View style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
          ...
          <View style={{ marginTop: 20, marginLeft: 30, marginRight: 20 }}>
            <View style={{ flexDirection: 'column', width: '100%' }}>
              ...
              <Text style={styles.textBold}>{this.state.cusName}</Text>
            </View>
            <View style={{ flexDirection: 'column', width: '100%' }}>
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#CCCCCC' }}>
        ...
        <Modal isVisible={this.state.isModalFormKosongPartsDesc}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
