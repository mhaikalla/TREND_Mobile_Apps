...
export default class PartsTechnicallScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getTicketNumber(idtr) {
    fetch(API.getTicketNumber, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'Authorization': 'r74Dkl9KUp7dsERGFmmA0uOoD1udYE',
  ...
  registerCall() {
    ...
    // this.state.queryParticipant.forEach((Participants)=>{
  ...
  actionSaveDraft() {
    if (this.state.isLoadingSaveDraft === true) {
      ...
      return (
        <TouchableOpacity block style={styles.bsave} >
          <ActivityIndicator size="small" color="#fff" />
        </TouchableOpacity>
      )
    }
  ...
  actionProduk() {
    const resetAction = StackActions.reset({
      index: 0,
      actions: [
        NavigationActions.navigate({ routeName: 'ProductScreen',params: {
            ticketCatIdSend: 0,
            trNoSend: ''
          } })
      ]
  ...
  render() {
    ...
    if (this.state.DeliveryDate != null){
      showDelivDate = <Text style={styles.textBold}>{this.state.DeliveryDate.substring(0, 10)}</Text>
    }
        ...
        <View style={{ backgroundColor: 'white' }}>
          ...
          <View style={{ marginTop: 20, marginLeft: 30, marginRight: 20 }}>
            <View style={{ flexDirection: 'column', width: '100%' }}>
              ...
              <Text style={styles.textBold}>{this.state.customer}</Text>
            </View>
            <View style={{ flexDirection: 'column', width: '100%' }}>
            ...
            <View style={{ flexDirection: 'column', width: '100%' }}>
              ...
              {/* <Text style={styles.textBold}>{this.state.DeliveryDate}</Text> */}
              {showDelivDate}
            </View>
            <View style={{ flexDirection: 'column', width: '100%' }}>
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#CCCCCC' }}>
        ...
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Data Request Description</Text>
        ...
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Data Manufacture</Text>
        ...
        >
          <View style={styles.viewmodal}>
            ...
            <TouchableOpacity onPress={() => this.toogleDonePartsDesc()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        ...
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Yout Parts Number</Text>
            <TouchableOpacity onPress={() => this.toogleDonePartsNumber()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
