...
export default class ExperimenScreen extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      isModalFormKosongServiceTool: false,
      isModalFormKosongEngine: false,
      isModalFormKosongEcm: false,
      isModalFormKosongTotal: false,
      isModalFormKosongReason: false,
      isModalFormKosongDiagnostic: false,
      ismodalformkosongResponder: false,
      ismodalformkosongFinterlock: false,
      ismodalformkosongTinterlock: false,
      ismodalformkosongSoftware: false,
      ismodalformkosongTS: false,
      ismodalformkosongTSWB: false,
      ismodalformkosongSMU : false,
    ...
    fetch(API.getDataEMP + data, {
      ...
      .then((responseJson) => {
        ...
        this.setState({
          ...
          branch: Data1.SalesOfficeDescription,
          branchoffice: Data1.SalesOffice
        })
      })
      .catch((error) => {
        // console.log(error)
  ...
  registerCall() {
    ...
    formData.append('ServiceToolSN', ""+this.state.dataServiceTool);
    ...
    formData.append('SerialNuDiagnosticClockmber', ""+this.state.curTime);
  ...
  saveDraft() {
    ...
    // console.log('payload API: ' + JSON.stringify(formData))
    fetch(API.registerPassword,
      {
        method: 'POST',
        headers: { 
  ...
  validationForm() {
    ...
    // } else if (this.state.dataServiceTool === '') {
    //   return this.setState({ isModalFormKosongServiceTool: true, isLoadingSubmit: false });
    // } else if (this.state.dataEngine === '') {
    //   return this.setState({ isModalFormKosongEngine: true, isLoadingSubmit: false });
    // } else if (this.state.dataEcm === '') {
    //   return this.setState({ isModalFormKosongEcm: true, isLoadingSubmit: false });
    // } else if (this.state.dataTotal === '') {
    //   return this.setState({ isModalFormKosongTotal: true, isLoadingSubmit: false });
    // } else if (this.state.dataReason === '') {
    //   return this.setState({ isModalFormKosongReason: true, isLoadingSubmit: false });
    // } else if (this.state.curTime === '') {
    //   return this.setState({ isModalFormKosongDiagnostic: true, isLoadingSubmit: false });
    // } 
    else if (this.state.query === '') {
      return this.setState({ isModalFormKosongResponder: true, isLoadingSubmit: false });
    } 
    else if (this.state.dataSMU === '') {
      return this.setState({ isModalFormKosongSMU: true, isLoadingSubmit: false });
    } 
    // else if (this.state.dataFinterlock === '') {
    //   return this.setState({ ismodalformkosongFinterlock: true, isLoadingSubmit: false });
    // } else if (this.state.dataTinterlock === '') {
    //   return this.setState({ ismodalformkosongTinterlock: true, isLoadingSubmit: false });
    // } else if (this.state.dataSoftware === '') {
    //   return this.setState({ ismodalformkosongSoftware: true, isLoadingSubmit: false });
    // } else if (this.state.dataTS === '') {
    //   return this.setState({ ismodalformkosongTS: true, isLoadingSubmit: false });
    // } else if (this.state.dataTSWB === '') {
    //   return this.setState({ ismodalformkosongTSWB: true, isLoadingSubmit: false });
    //} 
  ...
  validationFormSaveDraft() {
    ...
    // } else if (this.state.dataServiceTool === '' || this.state.dataServiceTool === null) {
    //   this.setState({ isModalFormKosongServiceTool: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataEngine === '' || this.state.dataEngine === null) {
    //   this.setState({ isModalFormKosongEngine: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataEcm === '' || this.state.dataEcm === null) {
    //   this.setState({ isModalFormKosongEcm: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataTotal === '' || this.state.dataTotal === null) {
    //   this.setState({ isModalFormKosongTotal: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataReason === '' || this.state.dataReason === null) {
    //   this.setState({ isModalFormKosongReason: true, isLoadingSaveDraft: false });
    // } else if (this.state.curTime === '' || this.state.curTime === null) {
    //   this.setState({ isModalFormKosongDiagnostic: true, isLoadingSaveDraft: false });
    // } else if (this.state.query === '' || this.state.query === null) {
    //   this.setState({ ismodalformkosongResponder: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataFinterlock === '' || this.state.dataFinterlock === null) {
    //   this.setState({ ismodalformkosongFinterlock: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataTinterlock === '' || this.state.dataTinterlock === null) {
    //   this.setState({ ismodalformkosongTinterlock: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataSoftware === '' || this.state.dataSoftware === null) {
    //   this.setState({ ismodalformkosongSoftware: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataTS === '' || this.state.dataTS === null) {
    //   this.setState({ ismodalformkosongTS: true, isLoadingSaveDraft: false });
    // } else if (this.state.dataTSWB === '' || this.state.dataTSWB === null) {
    //   this.setState({ ismodalformkosongTSWB: true, isLoadingSaveDraft: false });
    // } else if (this.state.ticketCatIdSend != 0) {
    //   this.saveDraftReopen();
    // } else {
    //   this.saveDraft();
  ...
  toogleDoneService() {
    this.setState({ isModalFormKosongServiceTool: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneEngine() {
    this.setState({ isModalFormKosongEngine: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneEcm() {
    this.setState({ isModalFormKosongEcm: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneTotal() {
    this.setState({ isModalFormKosongTotal: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneReason() {
    this.setState({ isModalFormKosongReason: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneDiagnostic() {
    this.setState({ isModalFormKosongDiagnostic: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneDescription() {
  ...
  toogleTwb() {
    this.setState({ ismodalformkosongTSWB: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneSMU() {
    this.setState({ isModalFormKosongSMU: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneFinterlock() {
    this.setState({ ismodalformkosongFinterlock: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneTinterlock() {
    this.setState({ ismodalformkosongTinterlock: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneSoftware() {
    this.setState({ ismodalformkosongSoftware: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneTS() {
    this.setState({ ismodalformkosongTS: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneTSWB() {
    this.setState({ ismodalformkosongTSWB: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  ...
  render() {
    let viewShow1, viewShow2, viewShow3, showClose, showMenu, showRef, showdelivdate, showsmudate;
    ...
    if (this.state.delivery != null){
      showdelivdate = <Text style={styles.textBold}>{this.state.delivery.substring(0,10)}</Text>
    }
        ...
        <View style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
          ...
          <View style={{ marginTop: 20, marginLeft: 30, marginRight: 20 }}>
            <View style={{ flexDirection: 'column', width: '100%' }}>
              ...
              <Text style={styles.textBold}>{this.state.branch}, {this.state.branchoffice}</Text>
            </View>
          </View>
          <View style={{ marginTop: 20, marginLeft: 30, marginRight: 20 }}>
            <View style={{ flexDirection: 'column', width: '100%' }}>
          ...
          <View style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
            ...
            <TextInput
              ...
              allowFontScaling={false}
              onChangeText={(curTime) => this.setState({ curTime: curTime })}
            />
          </View>
          <View style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
            <View>
      ...
      viewShow3 = <View>
        ...
        <View style={{ padding: 10 }}>
          <View style={{ borderRadius: 5, borderWidth: 1, padding: 10, borderColor: '#D7E0F1' }}>
            ...
            <TouchableOpacity onPress={this.selectMultipleFile.bind(this)}>
              <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#CCCCCC', padding: 10, borderRadius: 10 }}>
                <Text>Browse</Text>
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#CCCCCC' }}>
        ...
        <Modal isVisible={this.state.ismodalformkosongSMU}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your SMU</Text>
        ...
        <Modal isVisible={this.state.isModalFormKosongServiceTool}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Service Tool S/N</Text>
            <TouchableOpacity onPress={() => this.toogleDoneService()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongEngine}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Engine S/N</Text>
            <TouchableOpacity onPress={() => this.toogleDoneEngine()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongEcm}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Ecm S/N</Text>
            <TouchableOpacity onPress={() => this.toogleDoneEcm()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongReason}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Reason Code</Text>
            <TouchableOpacity onPress={() => this.toogleDoneReason()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongTotal}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Total Tattletale</Text>
            <TouchableOpacity onPress={() => this.toogleDoneTotal()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongDiagnostic}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Diagnostic Clock</Text>
            <TouchableOpacity onPress={() => this.toogleDoneDiagnostic()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        ...
        >
          <View style={styles.viewmodal}>
            ...
            <TouchableOpacity onPress={() => this.toogleDoneDescription()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        ...
        <Modal isVisible={this.state.ismodalformkosongFinterlock}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your From Interlock</Text>
            <TouchableOpacity onPress={() => this.setState({ ismodalformkosongFinterlock : false})} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>

        <Modal isVisible={this.state.ismodalformkosongTinterlock}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your To Interlock</Text>
            <TouchableOpacity onPress={() => this.toogleDoneTinterlock()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
     
        <Modal isVisible={this.state.ismodalformkosongSoftware}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Software Part Number</Text>
            <TouchableOpacity onPress={() => this.toogleDoneResponder()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        ...
        <Modal isVisible={this.state.ismodalformkosongTS}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Test Spesification</Text>
            <TouchableOpacity onPress={() => this.toogleDoneResponder()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        ...
        <Modal isVisible={this.state.ismodalformkosongTSWB}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Test Spesification With BrakeSaver</Text>
            <TouchableOpacity onPress={() => this.toogleTwb()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
