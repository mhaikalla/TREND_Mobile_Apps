...
export default class ExperimenScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isModalFormKosongPartCausing: false,
      isModalFormKosongPartDesc: false,
      isModalFormKosongSON: false,
      isModalFormKosongClaimNum: false,
      isModalFormKosongWarranty: false,
...
getWarrantytype(){
  ...
  registerCall() {
    ...
    formData.append('SMU', ""+this.state.SMU);
  ...
  validationForm() {
    if (this.state.dataTitle === '') {
      ...
      return this.setState({ isModalFormKosongPartCausing: true, isLoadingSubmit: false });
      ...
      return this.setState({ isModalFormKosongSON: true, isLoadingSubmit: false });
    } else if (this.state.dataClaimNumber === '') {
      return this.setState({ isModalFormKosongClaimNum: true, isLoadingSubmit: false });
    } else if (this.state.idWarranty === 0) {
      return this.setState({ isModalFormKosongWarranty: true, isLoadingSubmit: false });
  ...
  validationFormSaveDraft() {
    ...
    // } else if (this.state.dataPartCausing === '' || this.state.dataPartCausing === null) {
    //   this.setState({ isModalFormKosongPartCausing: true, isLoadingSaveDraft: false });
    ...
    // }else if (this.state.dataSON === '' || this.state.dataSON === null) {
    //   this.setState({ isModalFormKosongSON: true, isLoadingSaveDraft: false });
    // }else if (this.state.dataClaimNumber === '' || this.state.dataClaimNumber === null) {
    //   this.setState({ isModalFormKosongClaimNum: true, isLoadingSaveDraft: false });
    // } else if (this.state.idWarranty === 0 || this.state.idWarranty === null) {
    //   this.setState({ isModalFormKosongWarranty: true, isLoadingSaveDraft: false });
  ...
  toogleDoneSON() {
    this.setState({ isModalFormKosongSON: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDonePartCausing() {
    this.setState({ isModalFormKosongPartCausing: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneClaimNum() {
    this.setState({ isModalFormKosongClaimNum: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneWarranty() {
    this.setState({ isModalFormKosongWarranty: false, isLoadingSubmit: true, isLoadingSaveDraft: true })
  }
  toogleDoneResponder() {
  ...
  render() {
    let viewShow1, viewShow2, viewShow3, showClose, showMenu, showRef, showSmuDate, ShowDelivDate ;
      ...
      viewShow1 = <View>
        ...
        <View style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
            <View style={{ flexDirection: 'row', width: '100%' }}>
              ...
              <View style={{ width: '75%' }}>
                <Text style={styles.textall}>Warranty References</Text>
              </View>
            </View>
          </View>
          <View style={{ marginTop: 20, marginLeft: 20, marginRight: 20 }}>
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#CCCCCC' }}>
        ...
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Problem Description</Text>
            <TouchableOpacity onPress={() => this.toogleDoneDesc()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongPartCausing}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Parts Causing Failure</Text>
            <TouchableOpacity onPress={() => this.toogleDonePartCausing()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        ...
        <Modal isVisible={this.state.isModalFormKosongSON}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Serial Order Number</Text>
            <TouchableOpacity onPress={() => this.toogleDoneSON()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongWarranty}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Warranty Type</Text>
            <TouchableOpacity onPress={() => this.toogleDoneWarranty()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        <Modal isVisible={this.state.isModalFormKosongClaimNum}
          animationIn='bounceIn'
          animationOut='bounceOut'
        >
          <View style={styles.viewmodal}>
            <Text style={styles.textalertmodal}>Please Enter Your Claim Number</Text>
            <TouchableOpacity onPress={() => this.toogleDoneClaimNum()} style={[styles.buttonmodalOK]}>
              <Text style={{ fontWeight: '200', color: '#fff' }}>ok</Text>
            </TouchableOpacity>
          </View>
        </Modal>
